  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "h2": ["3.75rem", { lineHeight: "1.1", fontWeight: "700" }],
        "h3": ["3rem", { lineHeight: "1.2", fontWeight: "600" }],
        "h4": ["2.25rem", { lineHeight: "1.2", fontWeight: "600" }],
      ...
      colors: {
        ...
        orbe: {
          ...
          "surface-light": "hsl(var(--orbe-surface-light))",
        },
      },
      borderRadius: {
        "2xl": "1.5rem",
      ...
      boxShadow: {
        ...
        "glow-md": "0 0 40px -10px hsl(var(--primary) / 0.35)",
