      ...
      <section id="pricing" className="landing-section landing-pricing">
        ...
        <div className="landing-pricing-grid fade-up">
          {(() => {
            ...
            return [
              { plan: "Basic", planKey: "basic", price: currentPrices.basic, monthlyPrice: monthlyPrices.basic, period: "Módulo Financeiro", features: ["Planilha doméstica inteligente", "Registro via WhatsApp", "Dashboard financeiro", "Módulo Espiritual (Novo)"], disabled: ["Módulo de Estudos", "Módulo Fit", "Circadia & Inteligência", "Norte (Direção)"], featured: false },
              { plan: "Student", planKey: "student", price: currentPrices.student, monthlyPrice: monthlyPrices.student, period: "Financeiro + Estudos", features: ["Tudo do Basic", "Agenda acadêmica", "IA por matéria", "Módulo Espiritual (Novo)"], disabled: ["Módulo Fit", "Circadia & Inteligência", "Norte (Direção)"], featured: false },
              { plan: "Full", planKey: "full", price: currentPrices.full, monthlyPrice: monthlyPrices.full, period: "Todos os Módulos", features: ["Tudo do Student e Fit", "Módulo Espiritual (Novo)", "Circadia (Ritmo Biológico)", "Hábitos & Energia", "Norte (Direção Estratégica)"], disabled: [], featured: true },
              { plan: "Fit Only", planKey: "fit", price: currentPrices.fit, monthlyPrice: monthlyPrices.fit, period: "Financeiro + Fit", features: ["Tudo do Basic", "Plano alimentar IA", "Treinos Personalizados", "Módulo Espiritual (Novo)"], disabled: ["Módulo de Estudos", "Circadia & Inteligência", "Norte (Direção)"], featured: false },
            ].map((p) => {
